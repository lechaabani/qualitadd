...
class Constat extends \yii\db\ActiveRecord
{
	...
	public function afterFind()
    {
        ...
        $this->Cree_le = $this->Cree_le == 0 ? null : \DateTime::createFromFormat('Y-m-d H:i:s',$this->Cree_le)->format('d/m/Y');
		$this->Valide_le = $this->Valide_le == 0 ? null : \DateTime::createFromFormat('Y-m-d H:i:s',$this->Valide_le)->format('d/m/Y');
    ...
    public function beforeSave($insert)
    {
        ...
        $this->Cree_le = \DateTime::createFromFormat('d/m/Y',$this->Cree_le)->format('Y-m-d H:i:s');
        $this->Valide_le = \DateTime::createFromFormat('d/m/Y',$this->Valide_le)->format('Y-m-d H:i:s');
