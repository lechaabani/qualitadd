...
/**
 * DonneecontroleeSearch represents the model behind the search form about `app\models\Donneecontrolee`.
 */
class DonneecontroleeSearch extends Donneecontrolee
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
		...
		->from('donnee')
		->join('LEFT OUTER JOIN','controledonnee','controledonnee.id_donnee = donnee.identifiant')
		...
		->params([':identifiant' => $params['id_controle']])
        ...
        'asc' => ['controledonnee.id_donnee' => SORT_ASC],        
		'desc' => ['controledonnee.id_donnee' => SORT_DESC],
        ];
        ...
        $query->andFilterWhere([
            '<>','coalesce(controledonnee.id_controle,0)','ACT_C01',
        ]);
