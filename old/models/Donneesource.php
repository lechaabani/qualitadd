...
class Donneesource extends \yii\db\ActiveRecord
{
    ...
    public function addRelation($id_source,$id_donnee)
    {
    	try {
	    	$sql = "insert into donneesource (id_source,id_donnee) values ('$id_source','$id_donnee')"; 
    ...
    public function deleteRelation($id_source,$id_donnee)
    {
    	try {
	    	$sql = "delete from donneesource where id_source = '$id_source' and id_donnee = '$id_donnee'";
