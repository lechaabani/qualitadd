...
<div style="background:#f2f8f8;"><HR><b><font size="5" color="#033734"><?php echo '&nbsp; Caractéristiques'; ?></font></b><HR></div>
	...
	<label class="control-label">Créé le</label><?= $form->field($model, 'Cree_le')->widget(DatePicker::className(),[ 'dateFormat' => 'dd/MM/yyyy' ])->label(false); ?>
	...
	<label class="control-label">Validé le</label><?= $form->field($model, 'Valide_le')->widget(DatePicker::className(),[ 'dateFormat' => 'dd/MM/yyyy' ])->label(false) ?>
