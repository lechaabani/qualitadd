...
<!-- <?= Html::a('Test', ['donneecontrolee/index', 'id_controle' => 'ACT_C01'], ['class' => 'btn btn-primary']) ?> -->
    ...
    <?= Html::button('Ajouter un contrôle', ['value'=>Url::to(['donneecontrolee/index','id_controle' => $id_donnee]),'class'=>'btn btn-success', 'id'=>'modalButtonDC']) ?>
	<?php
		Modal::begin([
