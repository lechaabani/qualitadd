...
<div style="background:#f2f8f8;"><HR><b><font size="5" color="#033734"><?php echo '&nbsp; Définition'; ?></font></b><HR></div>
	...
	<label class="control-label">Date identification</label><?= $form->field($model, 'Date_identification')->widget(DatePicker::className(),[ 'dateFormat' => 'dd/MM/yyyy' ])->label(false) ?>
...
<div style="background:#f2f8f8;"><HR><b><font size="5" color="#033734"><?php echo '&nbsp; Remédiations'; ?></font></b><HR></div>
	...
	<label class="control-label">Date cible à respecter</label><?= $form->field($model, 'Date_cible_a_respecter')->widget(DatePicker::className(),[ 'dateFormat' => 'dd/MM/yyyy' ])->label(false) ?>
